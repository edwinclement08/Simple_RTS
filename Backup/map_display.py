...
pygame.init()
scream = pygame.display.set_mode((800,600))#,FULLSCREEN)

class Map:
    image_file = 'master.bmp'
    data_file = 'map.json'
    cur_pos = 0,0
    window_w,window_h =35,25        # No. of tiles
    x_offset, y_offset = 20,20


    def __init__(self):
        self.screen = pygame.Surface((self.window_w*20,self.window_h*20))
